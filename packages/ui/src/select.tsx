    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <select
          ...
          className={cn(
            'flex h-10 w-full appearance-none rounded-lg border border-surface-300 bg-white px-3 py-2 text-sm text-surface-900',
            'transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40 focus-visible:border-brand-400',
