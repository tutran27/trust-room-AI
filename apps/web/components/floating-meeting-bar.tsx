  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-slide-up">
      <Link href={`/meetings/${meetingId}`}>
        <div className="group flex items-center gap-3 rounded-2xl border border-indigo-200 bg-white/90 px-4 py-3 shadow-lg shadow-indigo-500/10 backdrop-blur-xl transition-all duration-200 hover:border-indigo-300 hover:shadow-indigo-500/20">
