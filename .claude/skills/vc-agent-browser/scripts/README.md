...
SKILL_DIR=""
if [ -d ".claude/skills/vc-agent-browser/scripts" ]; then
  SKILL_DIR=".claude/skills/vc-agent-browser/scripts"
elif [ -d "$HOME/.claude/skills/vc-agent-browser/scripts" ]; then
...
cd $SKILL_DIR/.claude/skills/vc-agent-browser/scripts
...
**Important**: Always save screenshots to `.claude/skills/vc-agent-browser/screenshots` directory.
