...
description: Planning context entrypoint — plan-shape calibration, SIMPLE vs COMPLEX, example plan shapes.
keywords: planning, plan, prd, simple, complex, calibration, generate-plan, example plan, roadmap
related: []
date: 20-06-26
readWhen: creating a new plan, calibrating SIMPLE vs COMPLEX
type: reference
---

# Planning Context

This file is the canonical planning context entrypoint for TrustRoom AI.
